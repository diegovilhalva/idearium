                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 p-6">
                        ...
                        <div class="border-b pb-6">
                            ...
                            <div class="mt-6 space-y-4">
                                <div class="flex items-center gap-4 text-gray-600">
                                    ...
                                    <span class="font-medium">1.2k seguidores</span>
                                </div>
                                ...
                                <button class="w-full px-6 py-3 bg-primary/10 text-primary rounded-lg hover:bg-primary/20 
                    ...
                    <div class="md:col-span-2 space-y-8">
                        @forelse ($posts as $post)
                            <article class="bg-white overflow-hidden shadow-sm rounded-xl hover:shadow-md transition-shadow">
                        ...
                        @empty
                            <div class="text-center py-12">
                                ...
                                <p class="mt-1 text-gray-500">Quando {{ $user->name }} publicar algo, aparecerá aqui.</p>
                            </div>
                        @endforelse
                        <div class="mt-8">
